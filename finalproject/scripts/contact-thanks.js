...
document.querySelector('#contact-request').innerHTML = `
<p>Your first name is: ${myInfo.get('first')}</P>
<p>Your last name is: ${myInfo.get('last')}</P>
<p>Your phone number is: ${myInfo.get('phone')}</P>
<p>Your appointment date is: ${myInfo.get('date')}</P>
<p>Your address is: ${myInfo.get('address')}</P>
<p>Your selected event is: ${myInfo.get('eventType')}</P>
`
